# Generated by Django 4.2.7 on 2024-02-07 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flavor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.flavor')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('done', 'Done'), ('inprocess', 'In Process'), ('canceled', 'Canceled')], max_length=20)),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('icecreams', models.ManyToManyField(to='app.icecream')),
